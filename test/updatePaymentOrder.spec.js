...
const updatePaymentOrder = require('../src/updatePaymentOrder/index')
...
describe('testing updatePaymentOrder method', function () {
  ...
  it('updatePaymentOrder method - OK', async () => {
    ...
    const result = await updatePaymentOrder(deps)('foo', 'bar', 1)
  ...
  it('updatePaymentOrder method - ERROR', async () => {
    ...
    try {
      await updatePaymentOrder(deps)('foo', 'bar', 2)
    } catch (error) {
